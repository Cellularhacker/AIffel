...
### 뉴스 요약
- 마크 저커버그는 AI 비서 '자비스' 개발에 대한 소식을 공개했다. 이는 영화 <아이언맨>에 등장하는 인물과 유사한 기능을 수행하는 집안 도우미 AI를 만드는 것을 목표로 한다. 프로젝트를 통해 사용자의 취향과 습관을 학습하고, 새로운 단어와 개념 및 얼굴 인식을 통해 상호작용을 기반으로 AI 기술을 발전시킬 것이라 얘기함.

### 느낀점
- 저커버그가 자비스 개바을 통해 미래지향적 AI 도구를 직접 구축하는 과정을 통해 AI 기술의 가능성과 희망적인 발전에 대한 기대를 높여 우리 삶의 질을 높일 것이다. 이러한 산업 현장의 개발자 꿈나무로서 시대에 뒤져지지않고 스스로 발전해야하는 생각이 들었다.
